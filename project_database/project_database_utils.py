...
#             monitor_target_edited_and_back_up(target_abspath=constants.pk_system_ARCHIVE_TOML)  # seconds_performance_test_results : ['11.95sec', '26.78sec', '11.94sec', '3.7sec', '11.72sec']
...
def move_target_to_trash_bin(target_abspath):
    ...
    # 휴지통 열기
    # pk_system.get_cmd_output('explorer.exe shell:RecycleBinFolder')
...
def run_loop_for_speak_as_async_deprecated(ment):
    async def speak_as_async(ment):
        ...
        # pk_system.pyglet_player 을 del 을 한 경우:
        ...
        # if hasattr(pk_system_, 'pyglet_player') and pk_system.pyglet_player is None:
        #     # pk_system.pyglet_player가 None인 경우
        #     pk_system.pyglet_player = pyglet.media.Player()
        #     pass
        if constants.pyglet_player != None:
                ...
                if type(ment) == str:
                    ...
                    try:
                        ...
                        try:
                            ...
                            # pk_system.multiprocessed_source_play = source
                            ...
                            # pk_system.multiprocessed_source_play = multiprocessing.Process(target= source.play , args=None)
                            # pk_system.multiprocessed_source_play.start()
